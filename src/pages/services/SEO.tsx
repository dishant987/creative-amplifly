...
const seoServices = [
  {
    ...
    description:
      "Comprehensive analysis of your website's technical performance and SEO health",
    features: [
  ...
  },
  {
    ...
    description:
      "In-depth keyword analysis to identify high-value opportunities for your business",
    features: [
...
const process = [
  {
    ...
    description:
      "We conduct a comprehensive audit of your website to identify opportunities and issues affecting your search performance.",
  },
  {
    step: 2,
    title: "Strategy Development",
    description:
      "Based on our findings, we create a custom SEO strategy tailored to your business goals and target audience.",
  },
  {
    step: 3,
    title: "Implementation",
    description:
      "Our team implements on-page optimizations, technical fixes, and content improvements across your website.",
  },
  {
    step: 4,
    title: "Content & Link Building",
    description:
      "We create high-quality content and build authoritative backlinks to boost your domain authority and rankings.",
  },
  {
    step: 5,
    title: "Monitoring & Optimization",
    description:
      "Continuous monitoring, testing, and optimization to ensure sustained growth and improved performance.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Typically, you'll start seeing improvements in 3-6 months, with significant results in 6-12 months. SEO is a long-term strategy that builds momentum over time.",
  },
  {
    question: "Do you guarantee first page rankings?",
    answer:
      "While we can't guarantee specific rankings (no ethical SEO agency can), we do guarantee improved visibility, traffic, and leads based on our proven methodology.",
  },
  {
    question: "What's included in your SEO services?",
    answer:
      "Our SEO services include technical audits, keyword research, on-page optimization, content strategy, link building, and monthly reporting with full transparency.",
  },
  {
    question: "How do you measure SEO success?",
    answer:
      "We track organic traffic growth, keyword rankings, conversion rates, and business metrics that matter to your bottom line, providing detailed monthly reports.",
  },
];
...
export default function SEO() {
  ...
  return (
    <div className=" bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-14 pb-20 bg-gradient-to-br from-background via-background to-muted/30">
          ...
          <div ref={heroRef} className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-foreground-muted mb-8 max-w-3xl mx-auto">
                ...
                data-driven SEO strategies. Get found by customers actively
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-foreground-muted">
              Average improvements our clients see within 6 months
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground-muted max-w-2xl mx-auto">
              From technical optimization to content strategy, we cover every
              aspect of SEO to maximize your online visibility.
            </p>
          </div>
          ...
          <Card className="glass max-w-4xl mx-auto text-center">
            <CardContent className="p-12">
              ...
              <p className="text-xl text-foreground-muted mb-8 max-w-2xl mx-auto">
                Get started with a comprehensive SEO audit and custom strategy
